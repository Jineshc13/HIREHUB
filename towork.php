...
<body>
    <section>
        <div class="heading">
            <div class="conatiner">
               <!---- <div class="signup"> -->
                    <h2 class="lg-heading">register to work</h2><hr>
                    <br><br>
    ...
    if(isset($_POST['submit'])){
            ...
            if($pass_decode)
        {
             ...
             $email_search = " SELECT * from towork where email='$email' " ;
             ...
             if($emailcount1)
            {
             ...
             ?>
                    ...
                    <?php
                 header('location: workersmainpage1.php');

                 
             }
             else
             {
                header('location: formtowork.php');
             }
        }  
        else
        {
